...
func RegisterUserInfoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserInfoServer) error {
	...
	mux.Handle("POST", pattern_UserInfo_GetUserInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/sso.UserInfo/GetUserInfo", runtime.WithHTTPPathPattern("/sso.UserInfo/GetUserInfo"))
		if err != nil {
...
func RegisterUserInfoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserInfoClient) error {
	...
	mux.Handle("POST", pattern_UserInfo_GetUserInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/sso.UserInfo/GetUserInfo", runtime.WithHTTPPathPattern("/sso.UserInfo/GetUserInfo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UserInfo_GetUserInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"sso.UserInfo", "GetUserInfo"}, ""))
)
